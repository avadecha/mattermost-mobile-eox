package com.eox.mattermost.rnbeta;
...
import com.eox.mattermost.helpers.RealPathUtil;
import com.eox.mattermost.share.ShareModule;
          ...
          new TurboReactPackage() {
                ...
                public ReactModuleInfoProvider getReactModuleInfoProvider() {
                  return () -> {
                    ...
                    map.put("MattermostManaged", new ReactModuleInfo("MattermostManaged", "com.eox.mattermost.rnbeta.MattermostManagedModule", false, false, false, false, false));
                    map.put("MattermostShare", new ReactModuleInfo("MattermostShare", "com.eox.mattermost.share.ShareModule", false, false, true, false, false));
                    map.put("Notifications", new ReactModuleInfo("Notifications", "com.eox.mattermost.rnbeta.NotificationsModule", false, false, false, false, false));
                    map.put("SplitView", new ReactModuleInfo("SplitView", "com.eox.mattermost.rnbeta.SplitViewModule", false, false, false, false, false));
                    return map;
                  };
                }
              }
